    ...
    <div className="min-h-screen bg-[#0b0b0f] flex flex-col items-center justify-center relative overflow-hidden font-sans selection:bg-indigo-500/30">
      ...
      <div className="relative z-10 w-full max-w-112.5 px-6 flex flex-col items-center py-12">
        ...
        <div className="text-center mb-10 w-full flex flex-col items-center">
          ...
          <h2 className="text-md text-slate-400 mb-6 font-medium tracking-tight">
        ...
        <div className="w-full bg-white/2 border border-white/10 backdrop-blur-xl rounded-2xl p-8 shadow-2xl hover:shadow-[0_8px_30px_rgb(49,46,129,0.15)] transition-all duration-500 flex flex-col group/card">
          ...
          >
            ...
            <svg className="w-5 h-5 fill-current relative z-10 group-hover:scale-105 transition-transform duration-300" viewBox="0 0 24 24" aria-hidden="true">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            ...
            {!isLogin && (
              <>
                ...
                <div className="flex flex-col gap-1.5">
                  <label className="text-xs font-medium text-slate-400 ml-1">Career Goal</label>
                  <input
                    type="text"
                    name="careergoal"
            ...
            {/* Standard Fields (Login & Register) */}
            <div className="flex flex-col gap-1.5">
            ...
            <button
              type="submit"
              className="mt-2 w-full bg-white text-black hover:bg-slate-200 font-medium px-4 py-3.5 rounded-xl transition-all text-sm shadow-[0_0_15px_rgba(255,255,255,0.1)] hover:shadow-[0_0_20px_rgba(255,255,255,0.2)] cursor-pointer"
            >
